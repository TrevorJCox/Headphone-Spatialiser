[Setup]
AppName=SpatialPodcast
AppVersion=1.0.0
DefaultDirName={pf}\SpatialPodcast
DefaultGroupName=SpatialPodcast
Compression=lzma2
SolidCompression=yes
OutputDir=.\
ArchitecturesInstallIn64BitMode=x64
OutputBaseFilename=SpatialPodcast Installer
...
[Files]
Source: "..\Builds\VisualStudio2015\Release\SpatialPodcast.dll"; DestDir: {code:GetVST2Dir_32}; Check: not Is64BitInstallMode; Components:vst2_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2015\Release\SpatialPodcast.dll"; DestDir: {code:GetVST2Dir_32}; Check: Is64BitInstallMode; Components:vst2_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2015\x64\Release\SpatialPodcast.dll"; DestDir: {code:GetVST2Dir_64}; Check: Is64BitInstallMode; Components:vst2_64; Flags: ignoreversion;

Source: "..\Builds\VisualStudio2015\Release\SpatialPodcast.aaxplugin\*.*"; DestDir: "{cf32}\Avid\Audio\Plug-Ins\SpatialPodcast.aaxplugin\"; Components:aax_32; Flags: ignoreversion recursesubdirs;
Source: "..\Builds\VisualStudio2015\x64\Release\SpatialPodcast.aaxplugin\*.*"; DestDir: "{cf}\Avid\Audio\Plug-Ins\SpatialPodcast.aaxplugin\"; Components:aax_64; Flags: ignoreversion recursesubdirs;

;Source: "..\manual\SpatialPodcast_manual.pdf"; DestDir: "{app}"
;Source: "changelog.txt"; DestDir: "{app}"
Source: "readmewin.rtf"; DestDir: "{app}"; DestName: "readme.rtf"; Flags: isreadme

[Icons]
;Name: "{group}\User guide"; Filename: "{app}\SpatialPodcast_manual.pdf"
;Name: "{group}\Changelog"; Filename: "{app}\changelog.txt"
;Name: "{group}\readme"; Filename: "{app}\readme.rtf"
Name: "{group}\Uninstall SpatialPodcast"; Filename: "{app}\unins000.exe"
